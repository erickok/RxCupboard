...
public class RxCupboard {
	...
	public static RxCupboard with(Cupboard cupboard, SQLiteDatabase db) {
		return new RxCupboard(cupboard, cupboard.withDatabase(db), db);
	}

	public static RxCupboard with(SQLiteDatabase db) {
		return new RxCupboard(CupboardFactory.cupboard(), CupboardFactory.cupboard().withDatabase(db), db);
	}

	private RxCupboard(Cupboard cupboard, DatabaseCompartment dc, SQLiteDatabase db) {
